                ...
                <div className='ismixan'>
                    ...
                    <div style={{ display: commentWidth && "block" }} className='comment'>
                        <div className="profilTextAndImg">
                            <div className="imgprofil"><img src="https:i.pinimg.com/236x/86/18/6f/86186f749b6ba5c82a676086c5229be2.jpg" alt="" /></div>
                            <div className="textPost"><p>tagiyevis</p></div>
                        </div>
                        <div><textarea value={commentValue} onChange={(e) => setCommentValue(e.target.value)} name="" id="" cols="50" rows="30" placeholder='Write a caption...'></textarea></div>
                    </div>
                </div>
            </div>
        </>
