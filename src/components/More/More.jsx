...
function More({ moreShow }) {
    ...
    const darkClickbutton = ()=>{
        ...
        // setColor( !darkClick? {backgroundColor: "black", color: "white" }:{ backgroundColor: "white", color: "black" })
    }
